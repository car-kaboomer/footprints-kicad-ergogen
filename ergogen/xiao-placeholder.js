...
// original footprint by FlatFootFox, tweaked by Zakwaykway/car explosion enjoyer.
module.exports = {
  params: {
    designator: 'MCU',
    /* Left Row */
    ...
    // GND pad; already defined above
    RST: {type: 'net', value: 'RST'},
    /* Power Cutout */
    BAT_POS: {type: 'net', value: 'BAT_POS'},
    // BAT_NEG pad; synonymous with GND, already defined above
